      ...
      <section className={styles.section__a}>
        ...
        <div className={styles.rhs}>
          <p>
            ...
            providing as much co-curricular and extra-curricular activities and
            events to help students cope with an academically rigorous education
            so our students can walk out of school ready for lives of leadership
            and service to their community. From Accounting to Actuarial Science
            and Insurance,to Business Administration,Finance,Employee Relations
            and people management, Management students Association is filled
            with activities that are both enriching and fun.
            <br />
            <br />
        ...
        <div className={styles.inner}>
          ...
          <div className={styles.our__mission}>
            <div className={styles.lhs}>
              ...
              <hr />
              <p>
                Our mission at Management Students Association is to develop the
                unique abilities and potential of each student by offering an
                enriched array of educational programs events and activities. We
                strive for excellence through a hands-on approach. Rich
                traditions rooted in our innovative approach to grow productive,
                caring, and intellectually curious graduates.
              </p>
            </div>
            <div className={styles.rhs}>
              <Image
                src="/images/exco-images/exco-3.jpg"
                width={400}
                height={500}
                alt="mission"
              />
          ...
          <div className={styles.values}>
            <div className={styles.our__philosophy}>
              ...
              <p>
                ...
                learning in a supportive and thoughtfully prepared environment.
              </p>
            </div>
